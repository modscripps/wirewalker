...
saprate = 4;
direction = 'up';
dep_start = datenum([2025,3,31,21,38,0]);
dep_end = datenum([2025,4,16,0,0,0]);
raw_data_files = dir('/Users/Devon/Documents/GradSchool/DTS/TLC25_Sig500/Raw/*.mat');
...
for i = 73:78%1:length(raw_data_files)
