...
splitfiles = 10;splitnum=1;
while splitfiles*splitnum<length(WWmeta.sortedname)/variables.NUM_combining_files+splitfiles
    ...
    save([WWmeta.gridpath,WWmeta.name_aqd,'_' num2str(splitnum-1) '.mat'],'ADCP');  % save result
end
